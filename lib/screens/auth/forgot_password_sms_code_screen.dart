...
class ForgotPasswordSmsCodeScreen extends StatefulWidget {
  ...
  const ForgotPasswordSmsCodeScreen({super.key, required this.onBack, required this.onContinue, required this.onTryAnotherWay});
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text("09******90", style: TextStyle(fontSize: 14)),
